...
namespace CreativeSpore.RpgMapEditor
{
    ...
    public class RpgMapHelper
    {
        ...
        public static Vector3 GetTileCenterPositionById(int id)
        {
            float tile_x = id % AutoTileMap.Instance.MapTileWidth * AutoTileMap.Instance.Tileset.TileWorldWidth;
            float tile_y = (id / AutoTileMap.Instance.MapTileWidth) * AutoTileMap.Instance.Tileset.TileWorldHeight;
