...
Use Ctrl/Cmd + Click to show / hide a game object only during editing. (Beware, this option works only in the editor. If you need to build game then you will need to put things back)
...
- Sorting game objects in alphabetical order 
For this you have to choose the QAlphabetNaturalSort option in the upper right corner of the Hierarchy window
