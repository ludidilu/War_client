...
namespace SRDebugger.Services
{
    public interface IDebugService
    {
        ...
        /// </param>
        void ShowDebugPanel(bool requireEntryCode);
        ...
        /// before opening the panel.
        /// </param>
        void ShowDebugPanel(DefaultTabs tab, bool requireEntryCode);
        ...
        void ShowBugReportSheet(ActionCompleteCallback onComplete, bool takeScreenshot,
