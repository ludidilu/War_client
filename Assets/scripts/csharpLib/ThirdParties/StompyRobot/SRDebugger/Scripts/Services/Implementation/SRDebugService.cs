...
namespace SRDebugger.Services.Implementation
{
    ...
    public class SRDebugService : IDebugService
    {
        ...
        public void ShowDebugPanel(bool requireEntryCode)
        {
        ...
        public void ShowDebugPanel(DefaultTabs tab, bool requireEntryCode)
        {
            if (requireEntryCode && _entryCodeEnabled && !_hasAuthorised)
            {
                _queuedTab = tab;
        ...
        public void ShowBugReportSheet(ActionCompleteCallback onComplete, bool takeScreenshot,
