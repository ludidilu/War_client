...
namespace SRDebugger.Services.Implementation
{
    ...
    public class StandardSystemInformationService : ISystemInformationService
    {
        ...
        public Dictionary<string, Dictionary<string, object>> CreateReport(bool includePrivate)
        {
        ...
        private class Info : ISystemInfo
        {
            ...
            public static Info Create(string name, Func<object> getter, bool isPrivate)
            {
                return new Info
                {
                    Title = name,
            ...
            public static Info Create(string name, object value, bool isPrivate)
            {
                return new Info
                {
                    Title = name,
