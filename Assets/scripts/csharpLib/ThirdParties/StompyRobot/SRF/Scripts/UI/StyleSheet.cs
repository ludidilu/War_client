...
namespace SRF.UI
{
    ...
    public class StyleSheet : ScriptableObject
    {
        ...
        public Style GetStyle(string key, bool searchParent)
        {
            ...
            if (i < 0)
            {
                ...
                {
                    return Parent.GetStyle(key,true);
                }
        ...
        public IEnumerable<string> GetStyleKeys(bool includeParent)
        {
            if (Parent != null && includeParent)
            {
                return _keys.Union(Parent.GetStyleKeys(true));
            }
